...
func p1() {
	...
	l.Lock()
	value = 6
	Put(CreateTuple(46, value), rsp, targets10)
	log("p1 w:%d", value)
	countwrites(value, 1, 6)
	l.Unlock()
	...
	l.Lock()
	value = 26
	Put(CreateTuple(208, value), rsp, targets14)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(250, value), rsp, targets15)
	log("p1 w:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(79, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(234, value), rsp, targets14)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(103, value), rsp, targets15)
	log("p4 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 12
	Put(CreateTuple(96, value), rsp, targets13)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(85, value), rsp, targets14)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 9
	Put(CreateTuple(66, value), rsp, targets15)
	log("p6 w:%d", value)
	countwrites(value, 6, 9)
	l.Unlock()
}
...
func p10() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(134, value), rsp, targets14)
	log("p10 w:%d", value)
	countwrites(value, 10, 17)
	l.Unlock()
...
func p11() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(215, value), rsp, targets14)
	log("p11 w:%d", value)
	countwrites(value, 11, 27)
	l.Unlock()
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(78, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(196, value), rsp, targets12)
	log("p13 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(241, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 7
	Put(CreateTuple(52, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 7)
	l.Unlock()
}
...
func p17() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(74, value), rsp, targets13)
	log("p17 w:%d", value)
	countwrites(value, 17, 10)
	l.Unlock()
...
func p22() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(103, value), rsp, targets14)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 2
	Put(CreateTuple(9, value), rsp, targets15)
	log("p23 w:%d", value)
	countwrites(value, 23, 2)
	l.Unlock()
}
...
func p24() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(245, value), rsp, targets14)
	log("p24 w:%d", value)
