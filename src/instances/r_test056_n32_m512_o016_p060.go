...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(277, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(410, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(181, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(328, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(66, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(509, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(313, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(367, value), rsp, targets3)
	log("p4 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(397, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(362, &value), rsp, s4)
	log("p4 r:%d", value)
	countreads(value, 4, 23)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(444, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(416, value), rsp, targets4)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(244, &value), rsp, s5)
	log("p5 r:%d", value)
	countreads(value, 5, 16)
	l.Unlock()
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(458, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(89, value), rsp, targets10)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(491, value), rsp, targets11)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(148, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(449, value), rsp, targets2)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(116, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(488, &value), rsp, s7)
	log("p7 r:%d", value)
	countreads(value, 7, 31)
	l.Unlock()
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(296, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(512, &value), rsp, s9)
	log("p9 r:%d", value)
	countreads(value, 9, 32)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(423, &value), rsp, s9)
	log("p9 r:%d", value)
	countreads(value, 9, 27)
	l.Unlock()
}
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(486, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(441, value), rsp, targets5)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(423, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(444, value), rsp, targets0)
	log("p12 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(57, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(297, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(262, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(285, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(240, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(191, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(299, value), rsp, targets5)
	log("p15 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(442, &value), rsp, s15)
	log("p15 r:%d", value)
	countreads(value, 15, 28)
	l.Unlock()
...
func p16() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(458, value), rsp, targets5)
	log("p16 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(209, value), rsp, targets8)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(237, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(4, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(342, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(265, value), rsp, targets8)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(293, value), rsp, targets5)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(191, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(301, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(124, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(262, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(433, &value), rsp, s20)
	log("p20 r:%d", value)
	countreads(value, 20, 28)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(289, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(261, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(186, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(191, &value), rsp, s21)
	log("p21 r:%d", value)
	countreads(value, 21, 12)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(275, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(317, value), rsp, targets8)
	log("p22 w:%d", value)
	countwrites(value, 22, 20)
	l.Unlock()
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(323, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(311, &value), rsp, s23)
	log("p23 r:%d", value)
	countreads(value, 23, 20)
	l.Unlock()
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s24)
	log("p24 r:%d", value)
	countreads(value, 24, 27)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(335, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(480, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(293, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(406, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(507, value), rsp, targets6)
	log("p25 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(22, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(456, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(423, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(43, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(504, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(68, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(405, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(319, value), rsp, targets2)
	log("p30 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(424, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(496, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(267, value), rsp, targets5)
	log("p31 w:%d", value)
	countwrites(value, 31, 17)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(345, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(270, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(303, value), rsp, targets1)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(324, &value), rsp, s32)
	log("p32 r:%d", value)
