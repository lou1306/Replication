...
func p3() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(141, value), rsp, targets13)
	log("p3 w:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(114, value), rsp, targets14)
	log("p3 w:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(119, value), rsp, targets15)
	log("p3 w:%d", value)
	countwrites(value, 3, 15)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(4, value), rsp, targets14)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(60, value), rsp, targets11)
	log("p6 w:%d", value)
	countwrites(value, 6, 8)
	l.Unlock()
...
func p7() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(219, value), rsp, targets14)
	log("p7 w:%d", value)
	countwrites(value, 7, 28)
	l.Unlock()
...
func p11() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(6, value), rsp, targets13)
	log("p11 w:%d", value)
...
func p13() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(74, value), rsp, targets12)
	log("p13 w:%d", value)
	...
	l.Lock()
	value = 12
	Put(CreateTuple(91, value), rsp, targets14)
	log("p13 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(162, value), rsp, targets14)
	log("p19 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(143, value), rsp, targets15)
	log("p24 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 14
	Put(CreateTuple(110, value), rsp, targets15)
	log("p26 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(20, value), rsp, targets13)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 12
	Put(CreateTuple(96, value), rsp, targets14)
	log("p29 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(58, value), rsp, targets15)
	log("p32 w:%d", value)
