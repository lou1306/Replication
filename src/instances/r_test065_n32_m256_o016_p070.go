...
func p3() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(142, value), rsp, targets11)
	log("p3 w:%d", value)
	countwrites(value, 3, 18)
	l.Unlock()
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(217, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 7
	Put(CreateTuple(50, value), rsp, targets11)
	log("p7 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(67, value), rsp, targets12)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 2
	Put(CreateTuple(11, value), rsp, targets15)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(206, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = 4
	Put(CreateTuple(27, value), rsp, targets8)
	log("p10 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(134, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(113, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(192, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(167, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(153, &value), rsp, s28)
	log("p28 r:%d", value)
