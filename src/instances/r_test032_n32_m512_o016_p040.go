...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(312, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(359, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(391, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(100, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(284, value), rsp, targets4)
	log("p3 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(497, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(400, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(213, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(221, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(334, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(433, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(455, &value), rsp, s5)
	log("p5 r:%d", value)
	countreads(value, 5, 29)
	l.Unlock()
}
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(475, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(394, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(364, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(475, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(353, &value), rsp, s7)
	log("p7 r:%d", value)
	countreads(value, 7, 23)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(480, &value), rsp, s7)
	log("p7 r:%d", value)
	countreads(value, 7, 30)
	l.Unlock()
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(453, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(346, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(137, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(316, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(85, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(428, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(502, value), rsp, targets1)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(491, value), rsp, targets7)
	log("p11 w:%d", value)
	countwrites(value, 11, 31)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(413, &value), rsp, s11)
	log("p11 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(437, &value), rsp, s11)
	log("p11 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(269, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(502, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(129, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(350, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(483, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(349, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(222, &value), rsp, s13)
	log("p13 r:%d", value)
	countreads(value, 13, 14)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(447, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(396, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(292, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(487, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(382, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(291, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(187, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(475, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(358, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(310, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(259, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(455, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 29)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(410, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(376, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(476, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(419, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(348, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(485, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(183, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(266, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(479, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(460, &value), rsp, s19)
	log("p19 r:%d", value)
	countreads(value, 19, 29)
	l.Unlock()
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(333, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(238, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(102, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(265, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(332, &value), rsp, s21)
	log("p21 r:%d", value)
	countreads(value, 21, 21)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(385, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(316, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(287, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(461, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(481, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(429, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(409, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(462, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(432, value), rsp, targets6)
	log("p23 w:%d", value)
	countwrites(value, 23, 27)
	l.Unlock()
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(300, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(290, &value), rsp, s24)
	log("p24 r:%d", value)
	countreads(value, 24, 19)
	l.Unlock()
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(241, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(390, &value), rsp, s25)
	log("p25 r:%d", value)
	countreads(value, 25, 25)
	l.Unlock()
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(299, &value), rsp, s26)
	log("p26 r:%d", value)
	countreads(value, 26, 19)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(301, &value), rsp, s26)
	log("p26 r:%d", value)
	countreads(value, 26, 19)
	l.Unlock()
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(343, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(137, &value), rsp, s27)
	log("p27 r:%d", value)
	countreads(value, 27, 9)
	l.Unlock()
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(385, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(449, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(91, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(501, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(323, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(336, value), rsp, targets5)
	log("p29 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(153, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(328, &value), rsp, s29)
	log("p29 r:%d", value)
	countreads(value, 29, 21)
	l.Unlock()
}
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(435, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(314, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(363, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(383, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(357, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(71, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(57, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(492, &value), rsp, s32)
	log("p32 r:%d", value)
