...
func p1() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(403, value), rsp, targets11)
	log("p1 w:%d", value)
	countwrites(value, 1, 26)
	l.Unlock()
	...
	l.Lock()
	value = 26
	Put(CreateTuple(402, value), rsp, targets12)
	log("p1 w:%d", value)
	countwrites(value, 1, 26)
	l.Unlock()
	...
	l.Lock()
	value = 6
	Put(CreateTuple(82, value), rsp, targets13)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(395, value), rsp, targets14)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(100, value), rsp, targets15)
	log("p1 w:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(196, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(396, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(328, value), rsp, targets9)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(136, value), rsp, targets11)
	log("p3 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(429, value), rsp, targets13)
	log("p3 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(335, value), rsp, targets7)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(108, value), rsp, targets13)
	log("p5 w:%d", value)
	countwrites(value, 5, 7)
	l.Unlock()
	...
	l.Lock()
	value = 19
	Put(CreateTuple(289, value), rsp, targets14)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(405, value), rsp, targets8)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(279, value), rsp, targets12)
	log("p7 w:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(320, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(274, value), rsp, targets4)
	log("p8 w:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(451, value), rsp, targets13)
	log("p8 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(288, value), rsp, targets10)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(175, value), rsp, targets14)
	log("p9 w:%d", value)
	countwrites(value, 9, 11)
	l.Unlock()
	...
	l.Lock()
	value = 17
	Put(CreateTuple(261, value), rsp, targets15)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(312, value), rsp, targets11)
	log("p10 w:%d", value)
	...
	l.Lock()
	value = 2
	Put(CreateTuple(18, value), rsp, targets12)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(132, value), rsp, targets4)
	log("p11 w:%d", value)
	countwrites(value, 11, 9)
	l.Unlock()
	...
	l.Lock()
	value = 16
	Put(CreateTuple(242, value), rsp, targets11)
	log("p11 w:%d", value)
	countwrites(value, 11, 16)
	l.Unlock()
	...
	l.Lock()
	value = 31
	Put(CreateTuple(491, value), rsp, targets12)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(323, value), rsp, targets15)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(461, value), rsp, targets14)
	log("p12 w:%d", value)
	countwrites(value, 12, 29)
	l.Unlock()
}
...
func p13() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(292, value), rsp, targets1)
	log("p13 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(313, value), rsp, targets11)
	log("p13 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(362, value), rsp, targets12)
	log("p13 w:%d", value)
	countwrites(value, 13, 23)
	l.Unlock()
}
...
func p14() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(466, value), rsp, targets12)
	log("p14 w:%d", value)
	countwrites(value, 14, 30)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(310, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(453, value), rsp, targets11)
	log("p15 w:%d", value)
	countwrites(value, 15, 29)
	l.Unlock()
	...
	l.Lock()
	value = 32
	Put(CreateTuple(506, value), rsp, targets14)
	log("p15 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 6
	Put(CreateTuple(84, value), rsp, targets13)
	log("p16 w:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(433, value), rsp, targets14)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(348, value), rsp, targets11)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(210, value), rsp, targets13)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(161, value), rsp, targets14)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(471, value), rsp, targets3)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(413, value), rsp, targets12)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(395, value), rsp, targets11)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(477, value), rsp, targets13)
	log("p19 w:%d", value)
	countwrites(value, 19, 30)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(269, value), rsp, targets5)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(444, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(347, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(211, value), rsp, targets14)
	log("p21 w:%d", value)
	countwrites(value, 21, 14)
	l.Unlock()
}
...
func p22() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(263, value), rsp, targets2)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(483, value), rsp, targets13)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(341, value), rsp, targets14)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 12
	Put(CreateTuple(184, value), rsp, targets15)
	log("p23 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(195, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(104, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(424, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(303, value), rsp, targets12)
	log("p26 w:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(460, value), rsp, targets13)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(355, value), rsp, targets1)
	log("p27 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(362, value), rsp, targets7)
	log("p27 w:%d", value)
	countwrites(value, 27, 23)
	l.Unlock()
	...
	l.Lock()
	value = 24
	Put(CreateTuple(369, value), rsp, targets11)
	log("p27 w:%d", value)
	countwrites(value, 27, 24)
	l.Unlock()
...
func p29() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(494, value), rsp, targets13)
	log("p29 w:%d", value)
	countwrites(value, 29, 31)
	l.Unlock()
	...
	l.Lock()
	value = 31
	Put(CreateTuple(494, value), rsp, targets14)
	log("p29 w:%d", value)
	countwrites(value, 29, 31)
	l.Unlock()
}
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(491, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(270, value), rsp, targets13)
	log("p31 w:%d", value)
	countwrites(value, 31, 17)
	l.Unlock()
}
...
func p32() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(384, value), rsp, targets9)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(88, value), rsp, targets11)
	log("p32 w:%d", value)
	countwrites(value, 32, 6)
	l.Unlock()
	...
	l.Lock()
	value = 24
	Put(CreateTuple(371, value), rsp, targets12)
	log("p32 w:%d", value)
	countwrites(value, 32, 24)
	l.Unlock()
	...
	l.Lock()
	value = 7
	Put(CreateTuple(100, value), rsp, targets13)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(322, value), rsp, targets14)
	log("p32 w:%d", value)
