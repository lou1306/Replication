...
func p1() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(27, value), rsp, targets11)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(172, value), rsp, targets15)
	log("p1 w:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(175, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(127, value), rsp, targets12)
	log("p5 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(194, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = 2
	Put(CreateTuple(15, value), rsp, targets12)
	log("p10 w:%d", value)
	countwrites(value, 10, 2)
	l.Unlock()
}
...
func p11() {
	...
	l.Lock()
	value = 15
	Put(CreateTuple(113, value), rsp, targets14)
	log("p11 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(57, value), rsp, targets8)
	log("p15 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(182, value), rsp, targets13)
	log("p16 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(194, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 25)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(32, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(133, value), rsp, targets10)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(57, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(239, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(73, value), rsp, targets14)
	log("p28 w:%d", value)
	countwrites(value, 28, 10)
	l.Unlock()
}
