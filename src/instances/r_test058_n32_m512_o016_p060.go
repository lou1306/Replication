...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(102, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(502, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(341, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(347, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(489, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(353, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(278, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(74, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(101, &value), rsp, s5)
	log("p5 r:%d", value)
	countreads(value, 5, 7)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(313, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(465, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(253, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(377, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(376, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(138, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(358, value), rsp, targets2)
	log("p8 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(355, value), rsp, targets8)
	log("p9 w:%d", value)
	countwrites(value, 9, 23)
	l.Unlock()
	...
	l.Lock()
	value = 30
	Put(CreateTuple(479, value), rsp, targets10)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(264, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(327, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(489, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(423, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(231, &value), rsp, s14)
	log("p14 r:%d", value)
	countreads(value, 14, 15)
	l.Unlock()
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(418, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(226, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(257, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(223, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(473, value), rsp, targets11)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = 3
	Put(CreateTuple(35, value), rsp, targets12)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(384, value), rsp, targets1)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(310, value), rsp, targets8)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(511, value), rsp, targets12)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(14, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(464, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s19)
	log("p19 r:%d", value)
	countreads(value, 19, 10)
	l.Unlock()
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(314, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(374, value), rsp, targets4)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(355, value), rsp, targets9)
	log("p20 w:%d", value)
	countwrites(value, 20, 23)
	l.Unlock()
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(379, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(493, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(502, value), rsp, targets5)
	log("p24 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(472, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(476, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(260, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(372, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(448, value), rsp, targets4)
	log("p25 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(511, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(107, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(13, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(131, value), rsp, targets10)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(374, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(452, &value), rsp, s32)
	log("p32 r:%d", value)
	countreads(value, 32, 29)
	l.Unlock()
