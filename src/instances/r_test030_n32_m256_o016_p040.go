...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(171, &value), rsp, s3)
	log("p3 r:%d", value)
	countreads(value, 3, 22)
	l.Unlock()
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(114, &value), rsp, s7)
	log("p7 r:%d", value)
	countreads(value, 7, 15)
	l.Unlock()
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(122, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(116, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(227, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(68, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(89, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(184, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(125, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(95, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(151, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(84, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(235, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(25, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(78, &value), rsp, s31)
	log("p31 r:%d", value)
