...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(209, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(128, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(239, &value), rsp, s4)
	log("p4 r:%d", value)
	countreads(value, 4, 30)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(95, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(179, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(149, &value), rsp, s10)
	log("p10 r:%d", value)
	countreads(value, 10, 19)
	l.Unlock()
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(84, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(212, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(139, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(36, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(74, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(122, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(14, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(54, &value), rsp, s32)
	log("p32 r:%d", value)
