...
func p2() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(67, value), rsp, targets14)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(133, value), rsp, targets15)
	log("p3 w:%d", value)
	countwrites(value, 3, 17)
	l.Unlock()
}
...
func p7() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(185, value), rsp, targets14)
	log("p7 w:%d", value)
	countwrites(value, 7, 24)
	l.Unlock()
}
...
func p10() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(252, value), rsp, targets12)
	log("p10 w:%d", value)
	countwrites(value, 10, 32)
	l.Unlock()
	...
	l.Lock()
	value = 29
	Put(CreateTuple(229, value), rsp, targets14)
	log("p10 w:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 15
	Put(CreateTuple(115, value), rsp, targets15)
	log("p14 w:%d", value)
	countwrites(value, 14, 15)
	l.Unlock()
}
...
func p16() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(164, value), rsp, targets15)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(220, value), rsp, targets13)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(40, value), rsp, targets15)
	log("p18 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(77, value), rsp, targets10)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(138, value), rsp, targets13)
	log("p21 w:%d", value)
	countwrites(value, 21, 18)
	l.Unlock()
	...
	l.Lock()
	value = 18
	Put(CreateTuple(138, value), rsp, targets14)
	log("p21 w:%d", value)
	countwrites(value, 21, 18)
	l.Unlock()
}
...
func p22() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(147, value), rsp, targets14)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(117, value), rsp, targets15)
	log("p22 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(212, value), rsp, targets14)
	log("p26 w:%d", value)
	countwrites(value, 26, 27)
	l.Unlock()
	...
	l.Lock()
	value = 25
	Put(CreateTuple(197, value), rsp, targets15)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(177, value), rsp, targets15)
	log("p27 w:%d", value)
	countwrites(value, 27, 23)
	l.Unlock()
}
...
func p31() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(40, value), rsp, targets14)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(50, value), rsp, targets15)
	log("p31 w:%d", value)
	countwrites(value, 31, 7)
	l.Unlock()
}
