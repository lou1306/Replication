...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(439, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(311, value), rsp, targets10)
	log("p3 w:%d", value)
	countwrites(value, 3, 20)
	l.Unlock()
	...
	l.Lock()
	value = 26
	Put(CreateTuple(410, value), rsp, targets14)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(43, value), rsp, targets14)
	log("p4 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(420, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(502, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(428, value), rsp, targets5)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(391, value), rsp, targets11)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(470, value), rsp, targets13)
	log("p7 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 12
	Put(CreateTuple(184, value), rsp, targets9)
	log("p9 w:%d", value)
	countwrites(value, 9, 12)
	l.Unlock()
	...
	l.Lock()
	value = 17
	Put(CreateTuple(268, value), rsp, targets10)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(281, value), rsp, targets11)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(408, value), rsp, targets14)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(451, value), rsp, targets12)
	log("p10 w:%d", value)
	countwrites(value, 10, 29)
	l.Unlock()
	...
	l.Lock()
	value = 9
	Put(CreateTuple(142, value), rsp, targets13)
	log("p10 w:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(294, value), rsp, targets14)
	log("p10 w:%d", value)
	countwrites(value, 10, 19)
	l.Unlock()
}
...
func p11() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(430, value), rsp, targets14)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(279, value), rsp, targets15)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(49, value), rsp, targets15)
	log("p12 w:%d", value)
...
func p13() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(398, value), rsp, targets10)
	log("p13 w:%d", value)
	countwrites(value, 13, 25)
	l.Unlock()
...
func p14() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(358, value), rsp, targets14)
	log("p14 w:%d", value)
	countwrites(value, 14, 23)
	l.Unlock()
}
...
func p16() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(509, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 32)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(347, value), rsp, targets13)
	log("p17 w:%d", value)
	countwrites(value, 17, 22)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(64, value), rsp, targets13)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(214, value), rsp, targets15)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(332, value), rsp, targets5)
	log("p19 w:%d", value)
	countwrites(value, 19, 21)
	l.Unlock()
	...
	l.Lock()
	value = 13
	Put(CreateTuple(205, value), rsp, targets14)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(112, value), rsp, targets15)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 14
	Put(CreateTuple(218, value), rsp, targets14)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(195, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(403, value), rsp, targets13)
	log("p21 w:%d", value)
...
func p22() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(286, value), rsp, targets10)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 1
	Put(CreateTuple(15, value), rsp, targets15)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(439, value), rsp, targets12)
	log("p23 w:%d", value)
	countwrites(value, 23, 28)
	l.Unlock()
	...
	l.Lock()
	value = 28
	Put(CreateTuple(441, value), rsp, targets13)
	log("p23 w:%d", value)
	countwrites(value, 23, 28)
	l.Unlock()
...
func p24() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(310, value), rsp, targets5)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(263, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(5, value), rsp, targets15)
	log("p27 w:%d", value)
	countwrites(value, 27, 1)
	l.Unlock()
}
...
func p28() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(269, value), rsp, targets11)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(58, value), rsp, targets8)
	log("p29 w:%d", value)
	countwrites(value, 29, 4)
	l.Unlock()
	...
	l.Lock()
	value = 17
	Put(CreateTuple(266, value), rsp, targets12)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(462, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(354, value), rsp, targets10)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(512, value), rsp, targets13)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(338, value), rsp, targets7)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(250, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = 4
	Put(CreateTuple(62, value), rsp, targets11)
	log("p32 w:%d", value)
	countwrites(value, 32, 4)
	l.Unlock()
