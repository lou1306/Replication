...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(258, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(288, value), rsp, targets9)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(310, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(496, value), rsp, targets13)
	log("p2 w:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(83, value), rsp, targets14)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(309, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(286, value), rsp, targets6)
	log("p4 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(283, value), rsp, targets10)
	log("p4 w:%d", value)
	countwrites(value, 4, 18)
	l.Unlock()
	...
	l.Lock()
	value = 25
	Put(CreateTuple(394, value), rsp, targets11)
	log("p4 w:%d", value)
	countwrites(value, 4, 25)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(362, value), rsp, targets4)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(435, value), rsp, targets6)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(298, value), rsp, targets7)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(80, value), rsp, targets11)
	log("p5 w:%d", value)
	countwrites(value, 5, 5)
	l.Unlock()
	...
	l.Lock()
	value = 22
	Put(CreateTuple(342, value), rsp, targets12)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 9
	Put(CreateTuple(144, value), rsp, targets14)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(501, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(158, value), rsp, targets12)
	log("p7 w:%d", value)
	countwrites(value, 7, 10)
	l.Unlock()
...
func p8() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(389, value), rsp, targets1)
	log("p8 w:%d", value)
	...
	l.Lock()
	value = 16
	Put(CreateTuple(255, value), rsp, targets12)
	log("p8 w:%d", value)
	countwrites(value, 8, 16)
	l.Unlock()
}
...
func p9() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(426, value), rsp, targets8)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(481, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(79, value), rsp, targets11)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(320, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(445, value), rsp, targets9)
	log("p10 w:%d", value)
	countwrites(value, 10, 28)
	l.Unlock()
	...
	l.Lock()
	value = 19
	Put(CreateTuple(291, value), rsp, targets13)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(462, &value), rsp, s11)
	log("p11 r:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(464, value), rsp, targets11)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(94, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(283, value), rsp, targets12)
	log("p12 w:%d", value)
...
func p13() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(487, value), rsp, targets10)
	log("p13 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(470, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(147, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(470, value), rsp, targets12)
	log("p14 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(419, value), rsp, targets14)
	log("p14 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(481, value), rsp, targets7)
	log("p15 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(470, value), rsp, targets11)
	log("p15 w:%d", value)
	countwrites(value, 15, 30)
	l.Unlock()
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(508, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(403, value), rsp, targets12)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(262, value), rsp, targets3)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(276, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(174, value), rsp, targets12)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(491, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(403, value), rsp, targets7)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(222, value), rsp, targets8)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(367, value), rsp, targets9)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(290, value), rsp, targets2)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(416, value), rsp, targets5)
	log("p19 w:%d", value)
	countwrites(value, 19, 26)
	l.Unlock()
	...
	l.Lock()
	value = 21
	Put(CreateTuple(321, value), rsp, targets11)
	log("p19 w:%d", value)
	countwrites(value, 19, 21)
	l.Unlock()
	...
	l.Lock()
	value = 19
	Put(CreateTuple(292, value), rsp, targets12)
	log("p19 w:%d", value)
	countwrites(value, 19, 19)
	l.Unlock()
	...
	l.Lock()
	value = 2
	Put(CreateTuple(21, value), rsp, targets14)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(165, value), rsp, targets15)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 11
	Put(CreateTuple(171, value), rsp, targets9)
	log("p20 w:%d", value)
	countwrites(value, 20, 11)
	l.Unlock()
...
func p22() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(367, value), rsp, targets5)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(118, &value), rsp, s22)
	log("p22 r:%d", value)
	countreads(value, 22, 8)
	l.Unlock()
	...
	l.Lock()
	value = 22
	Put(CreateTuple(347, value), rsp, targets6)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 16
	Put(CreateTuple(252, value), rsp, targets8)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(422, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(93, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(273, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(489, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(450, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(125, value), rsp, targets14)
	log("p25 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(306, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(496, value), rsp, targets10)
	log("p26 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(427, value), rsp, targets13)
	log("p26 w:%d", value)
	countwrites(value, 26, 27)
	l.Unlock()
}
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(37, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(369, value), rsp, targets10)
	log("p27 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(12, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(404, value), rsp, targets5)
	log("p28 w:%d", value)
	...
	l.Lock()
	value = 10
	Put(CreateTuple(155, value), rsp, targets7)
	log("p28 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(314, value), rsp, targets12)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(355, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(280, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(343, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(454, value), rsp, targets9)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(413, value), rsp, targets1)
	log("p30 w:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(458, value), rsp, targets7)
	log("p30 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(470, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(448, value), rsp, targets11)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(495, value), rsp, targets3)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(295, value), rsp, targets7)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(474, value), rsp, targets9)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(68, &value), rsp, s32)
	log("p32 r:%d", value)
