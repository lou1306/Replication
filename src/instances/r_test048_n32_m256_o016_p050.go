...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(21, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(74, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(118, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(136, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 17)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(251, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = 10
	Put(CreateTuple(76, value), rsp, targets7)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(26, &value), rsp, s19)
	log("p19 r:%d", value)
	countreads(value, 19, 4)
	l.Unlock()
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(108, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(86, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(234, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(76, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(214, &value), rsp, s32)
	log("p32 r:%d", value)
