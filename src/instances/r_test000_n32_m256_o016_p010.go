...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(99, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(85, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(102, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(103, &value), rsp, s2)
	log("p2 r:%d", value)
	countreads(value, 2, 13)
	l.Unlock()
}
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(52, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(41, &value), rsp, s5)
	log("p5 r:%d", value)
	countreads(value, 5, 6)
	l.Unlock()
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(173, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(184, &value), rsp, s8)
	log("p8 r:%d", value)
	countreads(value, 8, 23)
	l.Unlock()
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(176, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(164, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(73, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(252, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(117, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(226, &value), rsp, s14)
	log("p14 r:%d", value)
	countreads(value, 14, 29)
	l.Unlock()
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(149, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(248, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(131, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 17)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(78, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(91, &value), rsp, s17)
	log("p17 r:%d", value)
	countreads(value, 17, 12)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(235, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(210, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(192, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(134, &value), rsp, s18)
	log("p18 r:%d", value)
	countreads(value, 18, 17)
	l.Unlock()
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(137, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(34, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(91, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(10, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(123, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(162, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(103, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(64, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(239, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(115, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(183, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(56, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(163, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(105, &value), rsp, s28)
	log("p28 r:%d", value)
	countreads(value, 28, 14)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(116, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(185, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(252, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(156, &value), rsp, s32)
	log("p32 r:%d", value)
