...
func p2() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(144, value), rsp, targets11)
	log("p2 w:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(227, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(121, value), rsp, targets9)
	log("p10 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(203, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 26)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(48, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(124, value), rsp, targets12)
	log("p23 w:%d", value)
	countwrites(value, 23, 16)
	l.Unlock()
	...
	l.Lock()
	value = 8
	Put(CreateTuple(61, value), rsp, targets15)
	log("p23 w:%d", value)
	countwrites(value, 23, 8)
	l.Unlock()
}
...
func p24() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(191, value), rsp, targets10)
	log("p24 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(17, value), rsp, targets11)
	log("p27 w:%d", value)
	countwrites(value, 27, 3)
	l.Unlock()
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(226, &value), rsp, s28)
	log("p28 r:%d", value)
