...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(484, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(390, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(205, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(370, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(453, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(506, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(364, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(500, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(415, value), rsp, targets9)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 8
	Put(CreateTuple(122, value), rsp, targets10)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(445, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(458, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(158, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(3, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(429, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(106, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(412, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(332, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(207, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(313, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(84, value), rsp, targets10)
	log("p13 w:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(401, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(361, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(330, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(145, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(424, value), rsp, targets8)
	log("p15 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(471, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(468, value), rsp, targets0)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(28, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(510, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(511, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(280, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(294, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(328, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(401, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(350, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(274, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(341, value), rsp, targets7)
	log("p25 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(508, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(255, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(105, value), rsp, targets8)
	log("p26 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(320, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(510, value), rsp, targets7)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(359, &value), rsp, s29)
	log("p29 r:%d", value)
	countreads(value, 29, 23)
	l.Unlock()
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(387, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(263, &value), rsp, s31)
	log("p31 r:%d", value)
