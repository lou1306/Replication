...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(104, &value), rsp, s12)
	log("p12 r:%d", value)
	countreads(value, 12, 13)
	l.Unlock()
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(136, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(252, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(216, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(178, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(72, &value), rsp, s30)
	log("p30 r:%d", value)
