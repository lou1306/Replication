...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(512, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(201, value), rsp, targets13)
	log("p1 w:%d", value)
	countwrites(value, 1, 13)
	l.Unlock()
	...
	l.Lock()
	value = 16
	Put(CreateTuple(248, value), rsp, targets14)
	log("p1 w:%d", value)
	countwrites(value, 1, 16)
	l.Unlock()
}
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(160, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(479, value), rsp, targets12)
	log("p2 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(467, value), rsp, targets13)
	log("p2 w:%d", value)
	countwrites(value, 2, 30)
	l.Unlock()
}
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(296, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(462, value), rsp, targets12)
	log("p4 w:%d", value)
	countwrites(value, 4, 29)
	l.Unlock()
	...
	l.Lock()
	value = 27
	Put(CreateTuple(432, value), rsp, targets13)
	log("p4 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(385, value), rsp, targets15)
	log("p4 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(241, value), rsp, targets10)
	log("p5 w:%d", value)
	countwrites(value, 5, 16)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(308, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(368, value), rsp, targets12)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(309, value), rsp, targets14)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(67, value), rsp, targets15)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(195, value), rsp, targets7)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(329, value), rsp, targets8)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(395, value), rsp, targets13)
	log("p7 w:%d", value)
...
func p8() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(386, value), rsp, targets3)
	log("p8 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(501, value), rsp, targets12)
	log("p8 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(44, value), rsp, targets11)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(390, value), rsp, targets12)
	log("p9 w:%d", value)
	countwrites(value, 9, 25)
	l.Unlock()
}
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(406, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(414, value), rsp, targets6)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(483, value), rsp, targets10)
	log("p11 w:%d", value)
	countwrites(value, 11, 31)
	l.Unlock()
	...
	l.Lock()
	value = 3
	Put(CreateTuple(37, value), rsp, targets11)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(419, value), rsp, targets12)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(259, value), rsp, targets14)
	log("p11 w:%d", value)
	countwrites(value, 11, 17)
	l.Unlock()
	...
	l.Lock()
	value = 18
	Put(CreateTuple(273, value), rsp, targets15)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(67, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(274, value), rsp, targets9)
	log("p12 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(364, value), rsp, targets13)
	log("p12 w:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(94, value), rsp, targets14)
	log("p12 w:%d", value)
	countwrites(value, 12, 6)
	l.Unlock()
}
...
func p13() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(159, value), rsp, targets13)
	log("p13 w:%d", value)
	countwrites(value, 13, 10)
	l.Unlock()
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(367, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(64, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(405, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(498, value), rsp, targets11)
	log("p14 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(495, value), rsp, targets9)
	log("p15 w:%d", value)
	...
	l.Lock()
	value = 1
	Put(CreateTuple(16, value), rsp, targets14)
	log("p15 w:%d", value)
	countwrites(value, 15, 1)
	l.Unlock()
	...
	l.Lock()
	value = 3
	Put(CreateTuple(46, value), rsp, targets15)
	log("p15 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(420, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(447, value), rsp, targets11)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(301, value), rsp, targets6)
	log("p17 w:%d", value)
	countwrites(value, 17, 19)
	l.Unlock()
	...
	l.Lock()
	value = 19
	Put(CreateTuple(300, value), rsp, targets13)
	log("p17 w:%d", value)
	countwrites(value, 17, 19)
	l.Unlock()
}
...
func p18() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(125, value), rsp, targets8)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(299, value), rsp, targets12)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(405, value), rsp, targets5)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(418, value), rsp, targets6)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(406, value), rsp, targets6)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(202, value), rsp, targets12)
	log("p20 w:%d", value)
	countwrites(value, 20, 13)
	l.Unlock()
	...
	l.Lock()
	value = 31
	Put(CreateTuple(491, value), rsp, targets13)
	log("p20 w:%d", value)
	countwrites(value, 20, 31)
	l.Unlock()
	...
	l.Lock()
	value = 20
	Put(CreateTuple(310, value), rsp, targets15)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(271, value), rsp, targets5)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(203, value), rsp, targets12)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(413, value), rsp, targets13)
	log("p21 w:%d", value)
	countwrites(value, 21, 26)
	l.Unlock()
	...
	l.Lock()
	value = 2
	Put(CreateTuple(17, value), rsp, targets14)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(417, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(295, value), rsp, targets8)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(452, value), rsp, targets9)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 8
	Put(CreateTuple(121, value), rsp, targets10)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(100, value), rsp, targets14)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(465, value), rsp, targets15)
	log("p23 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(306, value), rsp, targets7)
	log("p24 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(502, value), rsp, targets12)
	log("p24 w:%d", value)
	countwrites(value, 24, 32)
	l.Unlock()
...
func p25() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(438, value), rsp, targets11)
	log("p25 w:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(370, value), rsp, targets12)
	log("p25 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(483, value), rsp, targets4)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(318, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(73, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(251, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(454, value), rsp, targets6)
	log("p28 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(333, value), rsp, targets11)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 2
	Put(CreateTuple(29, value), rsp, targets8)
	log("p29 w:%d", value)
	countwrites(value, 29, 2)
	l.Unlock()
	...
	l.Lock()
	value = 28
	Put(CreateTuple(438, value), rsp, targets9)
	log("p29 w:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(383, value), rsp, targets12)
	log("p29 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(176, value), rsp, targets13)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(419, value), rsp, targets11)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(447, value), rsp, targets5)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(472, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(487, value), rsp, targets11)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = 10
	Put(CreateTuple(152, value), rsp, targets13)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(197, value), rsp, targets14)
	log("p32 w:%d", value)
	countwrites(value, 32, 13)
	l.Unlock()
}
