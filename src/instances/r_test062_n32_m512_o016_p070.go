...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(145, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(232, value), rsp, targets13)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 29
	Put(CreateTuple(450, value), rsp, targets14)
	log("p1 w:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(377, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(436, value), rsp, targets4)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(488, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(312, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(388, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(262, value), rsp, targets10)
	log("p4 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(162, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(385, value), rsp, targets13)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(13, value), rsp, targets13)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(368, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(123, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(415, value), rsp, targets8)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(478, value), rsp, targets12)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(452, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(403, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(3, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(505, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(222, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(465, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(188, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(446, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(297, value), rsp, targets11)
	log("p15 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(334, value), rsp, targets12)
	log("p15 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(428, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(265, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(434, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(48, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(399, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(381, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(427, value), rsp, targets8)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(426, value), rsp, targets10)
	log("p18 w:%d", value)
	countwrites(value, 18, 27)
	l.Unlock()
...
func p19() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(324, value), rsp, targets6)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(480, value), rsp, targets9)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(316, value), rsp, targets13)
	log("p19 w:%d", value)
	countwrites(value, 19, 20)
	l.Unlock()
...
func p20() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(492, value), rsp, targets5)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(307, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(405, value), rsp, targets11)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(351, value), rsp, targets9)
	log("p21 w:%d", value)
	countwrites(value, 21, 22)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(314, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(276, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(207, value), rsp, targets10)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(213, value), rsp, targets12)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(314, value), rsp, targets13)
	log("p22 w:%d", value)
	countwrites(value, 22, 20)
	l.Unlock()
}
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(377, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(310, value), rsp, targets9)
	log("p23 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(28, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(341, value), rsp, targets10)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(418, value), rsp, targets11)
	log("p27 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(391, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(208, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(359, &value), rsp, s30)
	log("p30 r:%d", value)
	countreads(value, 30, 23)
	l.Unlock()
	...
	l.Lock()
	value = 17
	Put(CreateTuple(263, value), rsp, targets9)
	log("p30 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(427, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(229, value), rsp, targets12)
	log("p30 w:%d", value)
	countwrites(value, 30, 15)
	l.Unlock()
}
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(464, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(396, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(35, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(322, value), rsp, targets6)
	log("p32 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(267, &value), rsp, s32)
	log("p32 r:%d", value)
