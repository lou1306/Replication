...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(63, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(15, &value), rsp, s17)
	log("p17 r:%d", value)
	countreads(value, 17, 2)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(63, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(165, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(205, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(236, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(88, &value), rsp, s29)
	log("p29 r:%d", value)
	countreads(value, 29, 11)
	l.Unlock()
