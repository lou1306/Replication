...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(114, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(154, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(55, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(172, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(67, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(74, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(118, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(116, &value), rsp, s30)
	log("p30 r:%d", value)
