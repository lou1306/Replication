...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(106, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(32, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(92, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 12)
	l.Unlock()
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(151, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(229, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(170, &value), rsp, s32)
	log("p32 r:%d", value)
