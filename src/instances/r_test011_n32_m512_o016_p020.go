...
func p1() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(445, value), rsp, targets1)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(352, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(39, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(406, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(455, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(229, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(490, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(435, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(300, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(170, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(411, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(369, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(273, &value), rsp, s5)
	log("p5 r:%d", value)
	countreads(value, 5, 18)
	l.Unlock()
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(350, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(408, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(169, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(418, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(506, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(388, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(449, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(299, &value), rsp, s8)
	log("p8 r:%d", value)
	countreads(value, 8, 19)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(121, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(288, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(425, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(312, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(75, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(327, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(305, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(400, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(439, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(197, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(447, &value), rsp, s12)
	log("p12 r:%d", value)
	countreads(value, 12, 28)
	l.Unlock()
}
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(321, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(348, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(390, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(415, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(414, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(459, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(459, &value), rsp, s15)
	log("p15 r:%d", value)
	countreads(value, 15, 29)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(366, &value), rsp, s15)
	log("p15 r:%d", value)
	countreads(value, 15, 23)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(43, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(54, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(397, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(402, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(11, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(404, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 26)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(439, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(338, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(480, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(225, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(407, value), rsp, targets3)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(366, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(368, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(127, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(394, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(512, &value), rsp, s21)
	log("p21 r:%d", value)
	countreads(value, 21, 32)
	l.Unlock()
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(388, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(9, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s22)
	log("p22 r:%d", value)
	countreads(value, 22, 29)
	l.Unlock()
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(83, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(266, &value), rsp, s23)
	log("p23 r:%d", value)
	countreads(value, 23, 17)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(183, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(14, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(509, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(280, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(315, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(259, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(388, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(385, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(421, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(417, &value), rsp, s25)
	log("p25 r:%d", value)
	countreads(value, 25, 27)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s25)
	log("p25 r:%d", value)
	countreads(value, 25, 27)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(290, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(495, &value), rsp, s25)
	log("p25 r:%d", value)
	countreads(value, 25, 31)
	l.Unlock()
}
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(492, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(62, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(440, &value), rsp, s26)
	log("p26 r:%d", value)
	countreads(value, 26, 28)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(115, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(473, &value), rsp, s26)
	log("p26 r:%d", value)
	countreads(value, 26, 30)
	l.Unlock()
}
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(331, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(371, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(223, &value), rsp, s27)
	log("p27 r:%d", value)
	countreads(value, 27, 14)
	l.Unlock()
}
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(180, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(444, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(310, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(402, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(127, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(276, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(408, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(179, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(49, &value), rsp, s30)
	log("p30 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(401, &value), rsp, s30)
	log("p30 r:%d", value)
	countreads(value, 30, 26)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(48, &value), rsp, s30)
	log("p30 r:%d", value)
	countreads(value, 30, 3)
	l.Unlock()
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(292, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(127, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(262, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(55, &value), rsp, s31)
	log("p31 r:%d", value)
	countreads(value, 31, 4)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(431, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(434, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(207, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(380, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(268, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(296, &value), rsp, s32)
	log("p32 r:%d", value)
	countreads(value, 32, 19)
	l.Unlock()
