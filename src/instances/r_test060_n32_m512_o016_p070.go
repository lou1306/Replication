...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(412, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(400, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(278, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(157, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(474, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(317, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(507, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(474, value), rsp, targets10)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(411, value), rsp, targets1)
	log("p4 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(144, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(479, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(355, value), rsp, targets10)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 1
	Put(CreateTuple(14, value), rsp, targets11)
	log("p5 w:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(344, value), rsp, targets12)
	log("p5 w:%d", value)
	countwrites(value, 5, 22)
	l.Unlock()
	...
	l.Lock()
	value = 15
	Put(CreateTuple(240, value), rsp, targets13)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(397, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(58, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(87, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(462, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(487, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(220, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(280, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(366, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(316, value), rsp, targets12)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(376, value), rsp, targets13)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(512, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(379, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(304, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(161, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(473, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(503, &value), rsp, s15)
	log("p15 r:%d", value)
	countreads(value, 15, 32)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(512, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 12
	Put(CreateTuple(181, value), rsp, targets7)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(336, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(477, value), rsp, targets11)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(355, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(51, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(111, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(455, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(469, value), rsp, targets8)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s20)
	log("p20 r:%d", value)
	countreads(value, 20, 29)
	l.Unlock()
}
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(346, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(193, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(334, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(365, value), rsp, targets7)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(263, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(240, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(321, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(375, value), rsp, targets9)
	log("p27 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(311, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(464, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(63, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = 27
	Put(CreateTuple(432, value), rsp, targets8)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(477, value), rsp, targets10)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(218, &value), rsp, s31)
	log("p31 r:%d", value)
