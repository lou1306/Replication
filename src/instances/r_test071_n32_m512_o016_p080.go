...
func p1() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(499, value), rsp, targets7)
	log("p1 w:%d", value)
...
func p2() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(457, value), rsp, targets8)
	log("p2 w:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(73, value), rsp, targets9)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(494, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(401, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(309, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(238, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(422, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(265, value), rsp, targets10)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(276, value), rsp, targets12)
	log("p7 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(396, value), rsp, targets8)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(439, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = 9
	Put(CreateTuple(144, value), rsp, targets10)
	log("p9 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(182, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(267, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(409, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(442, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(499, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(448, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(369, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(241, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(498, value), rsp, targets13)
	log("p18 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(441, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(312, value), rsp, targets5)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(323, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(265, value), rsp, targets12)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(497, value), rsp, targets2)
	log("p20 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(241, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(314, value), rsp, targets7)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(154, value), rsp, targets10)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(168, value), rsp, targets11)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(284, value), rsp, targets12)
	log("p21 w:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(396, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = 4
	Put(CreateTuple(61, value), rsp, targets8)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 8
	Put(CreateTuple(120, value), rsp, targets12)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(279, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(295, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(342, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(396, value), rsp, targets14)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = 7
	Put(CreateTuple(109, value), rsp, targets13)
	log("p25 w:%d", value)
	...
	l.Lock()
	value = 3
	Put(CreateTuple(48, value), rsp, targets14)
	log("p25 w:%d", value)
	countwrites(value, 25, 3)
	l.Unlock()
}
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(245, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(138, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(172, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(349, value), rsp, targets5)
	log("p27 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(492, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 14
	Put(CreateTuple(209, value), rsp, targets14)
	log("p29 w:%d", value)
	...
	l.Lock()
	value = 3
	Put(CreateTuple(47, value), rsp, targets15)
	log("p29 w:%d", value)
	countwrites(value, 29, 3)
	l.Unlock()
}
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(259, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(493, value), rsp, targets9)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(392, value), rsp, targets13)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 4
	Put(CreateTuple(53, value), rsp, targets14)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(265, &value), rsp, s32)
	log("p32 r:%d", value)
