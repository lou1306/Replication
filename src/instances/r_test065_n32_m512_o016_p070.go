...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(160, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(373, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(107, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(294, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(240, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(290, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(512, value), rsp, targets7)
	log("p3 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(381, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(91, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(287, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(332, value), rsp, targets9)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(396, value), rsp, targets11)
	log("p7 w:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(418, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(176, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(195, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(479, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(54, value), rsp, targets10)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(64, value), rsp, targets11)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(135, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(358, value), rsp, targets6)
	log("p13 w:%d", value)
	countwrites(value, 13, 23)
	l.Unlock()
	...
	l.Lock()
	value = 32
	Put(CreateTuple(499, value), rsp, targets12)
	log("p13 w:%d", value)
	countwrites(value, 13, 32)
	l.Unlock()
	...
	l.Lock()
	value = 28
	Put(CreateTuple(440, value), rsp, targets13)
	log("p13 w:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(220, value), rsp, targets14)
	log("p13 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(375, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(124, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(376, value), rsp, targets12)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(279, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(6, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(470, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(438, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(272, value), rsp, targets10)
	log("p23 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(430, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(471, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = 10
	Put(CreateTuple(158, value), rsp, targets10)
	log("p25 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(490, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(359, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(485, value), rsp, targets2)
	log("p28 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(2, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(145, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(337, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(182, &value), rsp, s31)
	log("p31 r:%d", value)
	countreads(value, 31, 12)
	l.Unlock()
...
func p32() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(440, value), rsp, targets9)
	log("p32 w:%d", value)
