...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(274, &value), rsp, s1)
	log("p1 r:%d", value)
	countreads(value, 1, 18)
	l.Unlock()
	...
	l.Lock()
	value = 15
	Put(CreateTuple(237, value), rsp, targets11)
	log("p1 w:%d", value)
	countwrites(value, 1, 15)
	l.Unlock()
}
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(268, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(344, value), rsp, targets11)
	log("p3 w:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(268, value), rsp, targets14)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(469, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(372, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 6
	Put(CreateTuple(84, value), rsp, targets9)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 12
	Put(CreateTuple(180, value), rsp, targets12)
	log("p6 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(402, value), rsp, targets13)
	log("p6 w:%d", value)
	countwrites(value, 6, 26)
	l.Unlock()
...
func p8() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(443, value), rsp, targets0)
	log("p8 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(216, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(66, value), rsp, targets12)
	log("p8 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(379, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(414, value), rsp, targets2)
	log("p10 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(347, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(319, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(381, value), rsp, targets14)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(405, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(333, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(270, value), rsp, targets7)
	log("p14 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(303, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(295, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 19)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(273, value), rsp, targets11)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(293, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(454, value), rsp, targets11)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(364, value), rsp, targets14)
	log("p19 w:%d", value)
	countwrites(value, 19, 23)
	l.Unlock()
}
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(480, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(356, &value), rsp, s23)
	log("p23 r:%d", value)
	countreads(value, 23, 23)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(322, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(485, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(47, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(142, value), rsp, targets9)
	log("p26 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(167, value), rsp, targets11)
	log("p26 w:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(360, value), rsp, targets13)
	log("p26 w:%d", value)
	countwrites(value, 26, 23)
	l.Unlock()
	...
	l.Lock()
	value = 29
	Put(CreateTuple(464, value), rsp, targets14)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(32, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(68, value), rsp, targets11)
	log("p29 w:%d", value)
	countwrites(value, 29, 5)
	l.Unlock()
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(199, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(500, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(312, value), rsp, targets13)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(352, &value), rsp, s32)
	log("p32 r:%d", value)
