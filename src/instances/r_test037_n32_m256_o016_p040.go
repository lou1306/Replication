...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(87, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(139, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(193, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(118, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(50, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(163, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(210, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(132, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(160, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(103, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(144, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(157, &value), rsp, s22)
	log("p22 r:%d", value)
	countreads(value, 22, 20)
	l.Unlock()
}
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(32, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(225, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(236, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(161, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s28)
	log("p28 r:%d", value)
	countreads(value, 28, 1)
	l.Unlock()
}
