...
func p3() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(79, value), rsp, targets13)
	log("p3 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(59, value), rsp, targets9)
	log("p11 w:%d", value)
	countwrites(value, 11, 8)
	l.Unlock()
...
func p12() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(166, value), rsp, targets11)
	log("p12 w:%d", value)
	...
	l.Lock()
	value = 7
	Put(CreateTuple(55, value), rsp, targets14)
	log("p12 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(107, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(247, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 31)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(126, value), rsp, targets12)
	log("p20 w:%d", value)
	countwrites(value, 20, 16)
	l.Unlock()
}
...
func p32() {
	...
	l.Lock()
	value = 7
	Put(CreateTuple(53, value), rsp, targets12)
	log("p32 w:%d", value)
