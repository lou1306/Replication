...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(65, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(243, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(171, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(125, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(67, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(232, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(151, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(190, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(34, &value), rsp, s31)
	log("p31 r:%d", value)
	countreads(value, 31, 5)
	l.Unlock()
}
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(244, &value), rsp, s32)
	log("p32 r:%d", value)
	countreads(value, 32, 31)
	l.Unlock()
