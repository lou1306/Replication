...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(87, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(248, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(244, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(195, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(90, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(196, &value), rsp, s27)
	log("p27 r:%d", value)
