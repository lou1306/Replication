...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(246, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(101, value), rsp, targets13)
	log("p4 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(147, value), rsp, targets9)
	log("p12 w:%d", value)
	countwrites(value, 12, 19)
	l.Unlock()
...
func p19() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(125, value), rsp, targets13)
	log("p19 w:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(111, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(58, value), rsp, targets11)
	log("p29 w:%d", value)
