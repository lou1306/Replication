...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(218, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(163, value), rsp, targets15)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(190, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(150, value), rsp, targets14)
	log("p9 w:%d", value)
	countwrites(value, 9, 19)
	l.Unlock()
}
...
func p16() {
	...
	l.Lock()
	value = 23
	Put(CreateTuple(183, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 23)
	l.Unlock()
}
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(205, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(36, value), rsp, targets14)
	log("p27 w:%d", value)
