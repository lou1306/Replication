...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(203, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(250, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(249, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(80, &value), rsp, s26)
	log("p26 r:%d", value)
