...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(244, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(50, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(114, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(113, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(187, value), rsp, targets9)
	log("p11 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(218, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(242, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(229, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(10, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(176, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(136, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(126, &value), rsp, s32)
	log("p32 r:%d", value)
