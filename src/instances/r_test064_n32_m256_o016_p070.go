...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(172, value), rsp, targets13)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(132, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(148, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(7, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(222, value), rsp, targets13)
	log("p21 w:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(207, &value), rsp, s28)
	log("p28 r:%d", value)
