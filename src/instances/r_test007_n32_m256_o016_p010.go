...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(103, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(115, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(147, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(28, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(161, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(244, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(76, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(228, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(41, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(173, &value), rsp, s14)
	log("p14 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(236, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(119, &value), rsp, s17)
	log("p17 r:%d", value)
	countreads(value, 17, 15)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(162, &value), rsp, s18)
	log("p18 r:%d", value)
	countreads(value, 18, 21)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(254, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(71, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(221, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(172, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(76, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(224, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(105, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(164, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(35, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(190, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(248, &value), rsp, s27)
	log("p27 r:%d", value)
	countreads(value, 27, 31)
	l.Unlock()
}
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(242, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(5, &value), rsp, s29)
	log("p29 r:%d", value)
	countreads(value, 29, 1)
	l.Unlock()
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(202, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(44, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(23, &value), rsp, s32)
	log("p32 r:%d", value)
