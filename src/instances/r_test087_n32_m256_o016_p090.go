...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(158, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = 9
	Put(CreateTuple(69, value), rsp, targets14)
	log("p1 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(244, value), rsp, targets14)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(76, value), rsp, targets13)
	log("p7 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(65, value), rsp, targets15)
	log("p10 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(7, value), rsp, targets13)
	log("p12 w:%d", value)
	countwrites(value, 12, 1)
	l.Unlock()
	...
	l.Lock()
	value = 8
	Put(CreateTuple(59, value), rsp, targets14)
	log("p12 w:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 12
	Put(CreateTuple(89, value), rsp, targets12)
	log("p14 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(20, value), rsp, targets12)
	log("p15 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(58, value), rsp, targets14)
	log("p17 w:%d", value)
	countwrites(value, 17, 8)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = 15
	Put(CreateTuple(118, value), rsp, targets14)
	log("p18 w:%d", value)
	countwrites(value, 18, 15)
	l.Unlock()
}
...
func p21() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(170, value), rsp, targets12)
	log("p21 w:%d", value)
	countwrites(value, 21, 22)
	l.Unlock()
...
func p22() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(121, value), rsp, targets11)
	log("p22 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(254, value), rsp, targets14)
	log("p22 w:%d", value)
	countwrites(value, 22, 32)
	l.Unlock()
...
func p24() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(65, value), rsp, targets14)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(31, value), rsp, targets14)
	log("p25 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(141, value), rsp, targets15)
	log("p25 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(231, value), rsp, targets9)
	log("p27 w:%d", value)
	...
	l.Lock()
	value = 8
	Put(CreateTuple(57, value), rsp, targets15)
	log("p27 w:%d", value)
	countwrites(value, 27, 8)
	l.Unlock()
}
...
func p28() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(2, value), rsp, targets13)
	log("p28 w:%d", value)
	countwrites(value, 28, 1)
	l.Unlock()
	...
	l.Lock()
	value = 27
	Put(CreateTuple(216, value), rsp, targets14)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(166, value), rsp, targets12)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(198, value), rsp, targets15)
	log("p30 w:%d", value)
	countwrites(value, 30, 25)
	l.Unlock()
}
...
func p32() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(210, value), rsp, targets12)
	log("p32 w:%d", value)
