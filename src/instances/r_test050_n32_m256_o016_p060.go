...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(97, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(235, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(164, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(255, &value), rsp, s30)
	log("p30 r:%d", value)
	countreads(value, 30, 32)
	l.Unlock()
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(33, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(226, &value), rsp, s31)
	log("p31 r:%d", value)
