...
func p1() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(129, value), rsp, targets14)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(256, value), rsp, targets15)
	log("p1 w:%d", value)
	countwrites(value, 1, 32)
	l.Unlock()
}
...
func p2() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(207, value), rsp, targets13)
	log("p2 w:%d", value)
	countwrites(value, 2, 26)
	l.Unlock()
	...
	l.Lock()
	value = 23
	Put(CreateTuple(181, value), rsp, targets14)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 14
	Put(CreateTuple(108, value), rsp, targets14)
	log("p3 w:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(232, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(133, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(61, value), rsp, targets9)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(158, value), rsp, targets14)
	log("p9 w:%d", value)
...
func p10() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(209, value), rsp, targets13)
	log("p10 w:%d", value)
	countwrites(value, 10, 27)
	l.Unlock()
}
...
func p11() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(213, value), rsp, targets13)
	log("p11 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(239, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(250, value), rsp, targets14)
	log("p17 w:%d", value)
	countwrites(value, 17, 32)
	l.Unlock()
	...
	l.Lock()
	value = 22
	Put(CreateTuple(174, value), rsp, targets15)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(162, value), rsp, targets13)
	log("p18 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(222, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 4
	Put(CreateTuple(29, value), rsp, targets12)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(159, value), rsp, targets14)
	log("p23 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(97, value), rsp, targets12)
	log("p25 w:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(37, value), rsp, targets13)
	log("p25 w:%d", value)
	countwrites(value, 25, 5)
	l.Unlock()
...
func p26() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(190, value), rsp, targets15)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(206, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(127, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 22
	Put(CreateTuple(170, value), rsp, targets14)
	log("p30 w:%d", value)
	countwrites(value, 30, 22)
	l.Unlock()
	...
	l.Lock()
	value = 3
	Put(CreateTuple(19, value), rsp, targets15)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(226, value), rsp, targets10)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 3
	Put(CreateTuple(22, value), rsp, targets14)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = 19
	Put(CreateTuple(147, value), rsp, targets10)
	log("p32 w:%d", value)
	countwrites(value, 32, 19)
	l.Unlock()
	...
	l.Lock()
	value = 1
	Put(CreateTuple(1, value), rsp, targets12)
	log("p32 w:%d", value)
	countwrites(value, 32, 1)
	l.Unlock()
	...
	l.Lock()
	value = 8
	Put(CreateTuple(57, value), rsp, targets14)
	log("p32 w:%d", value)
