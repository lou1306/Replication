...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(218, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(140, &value), rsp, s9)
	log("p9 r:%d", value)
	countreads(value, 9, 18)
	l.Unlock()
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(27, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s11)
	log("p11 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(196, &value), rsp, s11)
	log("p11 r:%d", value)
	countreads(value, 11, 25)
	l.Unlock()
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(82, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(62, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(113, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(14, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(198, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(247, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(78, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(56, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(216, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(129, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(177, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(35, &value), rsp, s29)
	log("p29 r:%d", value)
