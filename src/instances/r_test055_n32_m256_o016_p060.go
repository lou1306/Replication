...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(194, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(232, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(37, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(94, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(13, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(220, &value), rsp, s17)
	log("p17 r:%d", value)
	countreads(value, 17, 28)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(115, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(117, &value), rsp, s20)
	log("p20 r:%d", value)
	countreads(value, 20, 15)
	l.Unlock()
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(176, &value), rsp, s28)
	log("p28 r:%d", value)
