...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(229, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(107, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(85, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(195, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 11
	Put(CreateTuple(88, value), rsp, targets10)
	log("p17 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(84, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(84, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(95, &value), rsp, s29)
	log("p29 r:%d", value)
