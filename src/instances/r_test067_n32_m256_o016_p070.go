...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(43, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(205, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(252, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(36, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(247, value), rsp, targets13)
	log("p13 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(127, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(151, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(6, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(221, &value), rsp, s31)
	log("p31 r:%d", value)
