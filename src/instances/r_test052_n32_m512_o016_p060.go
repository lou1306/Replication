...
func p1() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(382, value), rsp, targets4)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(292, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(281, value), rsp, targets8)
	log("p1 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(331, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(263, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(461, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(322, value), rsp, targets8)
	log("p2 w:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(330, value), rsp, targets10)
	log("p2 w:%d", value)
	countwrites(value, 2, 21)
	l.Unlock()
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(167, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(499, value), rsp, targets4)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(481, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(76, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(294, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(510, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(26, &value), rsp, s6)
	log("p6 r:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(356, value), rsp, targets9)
	log("p6 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(167, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(422, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(362, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(57, &value), rsp, s7)
	log("p7 r:%d", value)
	countreads(value, 7, 4)
	l.Unlock()
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(369, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(435, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(440, &value), rsp, s8)
	log("p8 r:%d", value)
	countreads(value, 8, 28)
	l.Unlock()
}
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(446, &value), rsp, s9)
	log("p9 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(237, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(150, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(457, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = 9
	Put(CreateTuple(142, value), rsp, targets8)
	log("p10 w:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(378, value), rsp, targets10)
	log("p10 w:%d", value)
...
func p11() {
	...
	l.Lock()
	value = 26
	Put(CreateTuple(405, value), rsp, targets10)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(350, value), rsp, targets11)
	log("p11 w:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(273, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(280, &value), rsp, s12)
	log("p12 r:%d", value)
	countreads(value, 12, 18)
	l.Unlock()
}
...
func p13() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(463, value), rsp, targets5)
	log("p13 w:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(340, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(170, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(479, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(319, value), rsp, targets8)
	log("p15 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(419, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = 3
	Put(CreateTuple(45, value), rsp, targets11)
	log("p16 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(439, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(397, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(254, &value), rsp, s17)
	log("p17 r:%d", value)
	countreads(value, 17, 16)
	l.Unlock()
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(222, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = 23
	Put(CreateTuple(353, value), rsp, targets7)
	log("p18 w:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(161, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(96, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = 21
	Put(CreateTuple(326, value), rsp, targets8)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(502, value), rsp, targets8)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(135, value), rsp, targets6)
	log("p21 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(97, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(10, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(506, &value), rsp, s22)
	log("p22 r:%d", value)
	countreads(value, 22, 32)
	l.Unlock()
}
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(235, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(317, &value), rsp, s23)
	log("p23 r:%d", value)
	countreads(value, 23, 20)
	l.Unlock()
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(331, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(394, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(359, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(261, value), rsp, targets8)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(504, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(203, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(509, &value), rsp, s26)
	log("p26 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(470, value), rsp, targets6)
	log("p26 w:%d", value)
	countwrites(value, 26, 30)
	l.Unlock()
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(121, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(181, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(349, &value), rsp, s28)
	log("p28 r:%d", value)
	countreads(value, 28, 22)
	l.Unlock()
}
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(486, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(320, value), rsp, targets8)
	log("p29 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(399, value), rsp, targets6)
	log("p30 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(372, value), rsp, targets8)
	log("p32 w:%d", value)
	countwrites(value, 32, 24)
	l.Unlock()
