...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(285, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = 28
	Put(CreateTuple(445, value), rsp, targets8)
	log("p2 w:%d", value)
	countwrites(value, 2, 28)
	l.Unlock()
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(62, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(452, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(486, value), rsp, targets6)
	log("p3 w:%d", value)
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(391, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(370, value), rsp, targets5)
	log("p4 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(415, &value), rsp, s4)
	log("p4 r:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(311, value), rsp, targets8)
	log("p4 w:%d", value)
	countwrites(value, 4, 20)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(320, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(403, &value), rsp, s6)
	log("p6 r:%d", value)
	countreads(value, 6, 26)
	l.Unlock()
...
func p7() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(327, &value), rsp, s7)
	log("p7 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(342, &value), rsp, s7)
	log("p7 r:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(302, &value), rsp, s8)
	log("p8 r:%d", value)
...
func p9() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(477, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(411, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(418, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(506, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(507, &value), rsp, s12)
	log("p12 r:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(194, &value), rsp, s13)
	log("p13 r:%d", value)
	countreads(value, 13, 13)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(393, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 27
	Put(CreateTuple(420, value), rsp, targets7)
	log("p14 w:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(297, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(296, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(272, value), rsp, targets7)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = 32
	Put(CreateTuple(511, value), rsp, targets8)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(30, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(485, &value), rsp, s19)
	log("p19 r:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(430, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(312, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(365, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(356, &value), rsp, s20)
	log("p20 r:%d", value)
	countreads(value, 20, 23)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(246, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(302, &value), rsp, s21)
	log("p21 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(271, &value), rsp, s21)
	log("p21 r:%d", value)
	countreads(value, 21, 17)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(491, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(507, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(303, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(121, &value), rsp, s22)
	log("p22 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(369, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p23() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(456, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(184, &value), rsp, s23)
	log("p23 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(165, &value), rsp, s23)
	log("p23 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(261, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(264, &value), rsp, s24)
	log("p24 r:%d", value)
	countreads(value, 24, 17)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(374, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(78, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(442, value), rsp, targets7)
	log("p25 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(134, value), rsp, targets11)
	log("p26 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(445, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(393, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(232, &value), rsp, s29)
	log("p29 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(296, &value), rsp, s29)
	log("p29 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(467, value), rsp, targets12)
	log("p30 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(388, &value), rsp, s31)
	log("p31 r:%d", value)
	countreads(value, 31, 25)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(147, &value), rsp, s31)
	log("p31 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(469, value), rsp, targets7)
	log("p31 w:%d", value)
	...
	l.Lock()
	value = 6
	Put(CreateTuple(81, value), rsp, targets11)
	log("p31 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(109, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(437, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(486, value), rsp, targets10)
	log("p32 w:%d", value)
