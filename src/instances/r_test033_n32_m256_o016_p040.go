...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(75, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 31
	Put(CreateTuple(248, value), rsp, targets10)
	log("p3 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(160, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p11() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(57, &value), rsp, s11)
	log("p11 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(167, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(27, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(233, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(142, &value), rsp, s30)
	log("p30 r:%d", value)
