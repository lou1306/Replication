...
func p12() {
	...
	l.Lock()
	value = 13
	Put(CreateTuple(103, value), rsp, targets12)
	log("p12 w:%d", value)
	...
	l.Lock()
	value = 11
	Put(CreateTuple(82, value), rsp, targets14)
	log("p12 w:%d", value)
	countwrites(value, 12, 11)
	l.Unlock()
}
...
func p23() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(255, value), rsp, targets11)
	log("p23 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(11, &value), rsp, s24)
	log("p24 r:%d", value)
