...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(506, &value), rsp, s1)
	log("p1 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(485, &value), rsp, s1)
	log("p1 r:%d", value)
	countreads(value, 1, 31)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(148, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(73, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(90, &value), rsp, s3)
	log("p3 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(273, &value), rsp, s3)
	log("p3 r:%d", value)
	countreads(value, 3, 18)
	l.Unlock()
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(356, &value), rsp, s4)
	log("p4 r:%d", value)
	countreads(value, 4, 23)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(375, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(77, &value), rsp, s5)
	log("p5 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(384, &value), rsp, s5)
	log("p5 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(401, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(402, value), rsp, targets6)
	log("p12 w:%d", value)
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(79, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(146, &value), rsp, s13)
	log("p13 r:%d", value)
	countreads(value, 13, 10)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(479, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(104, &value), rsp, s13)
	log("p13 r:%d", value)
	countreads(value, 13, 7)
	l.Unlock()
}
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(189, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(466, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(135, &value), rsp, s15)
	log("p15 r:%d", value)
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(447, &value), rsp, s16)
	log("p16 r:%d", value)
	countreads(value, 16, 28)
	l.Unlock()
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(265, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(285, &value), rsp, s17)
	log("p17 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(397, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(411, &value), rsp, s19)
	log("p19 r:%d", value)
	countreads(value, 19, 26)
	l.Unlock()
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(489, &value), rsp, s20)
	log("p20 r:%d", value)
...
func p21() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(287, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p22() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(348, &value), rsp, s22)
	log("p22 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(471, &value), rsp, s24)
	log("p24 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(347, &value), rsp, s24)
	log("p24 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(371, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(167, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(442, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(169, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(323, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(386, &value), rsp, s27)
	log("p27 r:%d", value)
...
func p28() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(314, value), rsp, targets6)
	log("p28 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(268, value), rsp, targets12)
	log("p29 w:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(67, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(367, &value), rsp, s32)
	log("p32 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(294, &value), rsp, s32)
	log("p32 r:%d", value)
