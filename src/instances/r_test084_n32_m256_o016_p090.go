...
func p3() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(6, value), rsp, targets12)
	log("p3 w:%d", value)
	countwrites(value, 3, 1)
	l.Unlock()
...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(253, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(240, value), rsp, targets14)
	log("p5 w:%d", value)
...
func p7() {
	...
	l.Lock()
	value = 7
	Put(CreateTuple(55, value), rsp, targets12)
	log("p7 w:%d", value)
	...
	l.Lock()
	value = 2
	Put(CreateTuple(13, value), rsp, targets15)
	log("p7 w:%d", value)
...
func p17() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(229, value), rsp, targets15)
	log("p17 w:%d", value)
	countwrites(value, 17, 29)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(133, value), rsp, targets13)
	log("p20 w:%d", value)
	countwrites(value, 20, 17)
	l.Unlock()
}
...
func p25() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(73, value), rsp, targets15)
	log("p25 w:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(70, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = 19
	Put(CreateTuple(150, value), rsp, targets12)
	log("p27 w:%d", value)
	...
	l.Lock()
	value = 20
	Put(CreateTuple(155, value), rsp, targets14)
	log("p27 w:%d", value)
	countwrites(value, 27, 20)
	l.Unlock()
}
...
func p28() {
	...
	l.Lock()
	value = 6
	Put(CreateTuple(46, value), rsp, targets14)
	log("p28 w:%d", value)
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(200, &value), rsp, s30)
	log("p30 r:%d", value)
