...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(252, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(107, value), rsp, targets13)
	log("p2 w:%d", value)
	countwrites(value, 2, 14)
	l.Unlock()
	...
	l.Lock()
	value = 15
	Put(CreateTuple(119, value), rsp, targets14)
	log("p2 w:%d", value)
...
func p3() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(72, value), rsp, targets14)
	log("p3 w:%d", value)
	countwrites(value, 3, 9)
	l.Unlock()
}
...
func p5() {
	...
	l.Lock()
	value = 29
	Put(CreateTuple(231, value), rsp, targets14)
	log("p5 w:%d", value)
	countwrites(value, 5, 29)
	l.Unlock()
}
...
func p7() {
	...
	l.Lock()
	value = 16
	Put(CreateTuple(124, value), rsp, targets13)
	log("p7 w:%d", value)
	countwrites(value, 7, 16)
	l.Unlock()
}
...
func p9() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(154, value), rsp, targets11)
	log("p9 w:%d", value)
	countwrites(value, 9, 20)
	l.Unlock()
...
func p11() {
	...
	l.Lock()
	value = 11
	Put(CreateTuple(86, value), rsp, targets11)
	log("p11 w:%d", value)
	...
	l.Lock()
	value = 22
	Put(CreateTuple(171, value), rsp, targets13)
	log("p11 w:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 20
	Put(CreateTuple(159, value), rsp, targets12)
	log("p14 w:%d", value)
	...
	l.Lock()
	value = 17
	Put(CreateTuple(133, value), rsp, targets14)
	log("p14 w:%d", value)
	countwrites(value, 14, 17)
	l.Unlock()
}
...
func p16() {
	...
	l.Lock()
	value = 8
	Put(CreateTuple(63, value), rsp, targets14)
	log("p16 w:%d", value)
	countwrites(value, 16, 8)
	l.Unlock()
	...
	l.Lock()
	value = 6
	Put(CreateTuple(43, value), rsp, targets15)
	log("p16 w:%d", value)
	countwrites(value, 16, 6)
	l.Unlock()
}
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(129, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(39, value), rsp, targets10)
	log("p17 w:%d", value)
	...
	l.Lock()
	value = 18
	Put(CreateTuple(143, value), rsp, targets14)
	log("p17 w:%d", value)
	countwrites(value, 17, 18)
	l.Unlock()
}
...
func p18() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(71, value), rsp, targets13)
	log("p18 w:%d", value)
	countwrites(value, 18, 9)
	l.Unlock()
}
...
func p20() {
	...
	l.Lock()
	value = 1
	Put(CreateTuple(8, value), rsp, targets13)
	log("p20 w:%d", value)
...
func p21() {
	...
	l.Lock()
	value = 17
	Put(CreateTuple(136, value), rsp, targets14)
	log("p21 w:%d", value)
	countwrites(value, 21, 17)
	l.Unlock()
	...
	l.Lock()
	value = 24
	Put(CreateTuple(185, value), rsp, targets15)
	log("p21 w:%d", value)
...
func p22() {
	...
	l.Lock()
	value = 25
	Put(CreateTuple(197, value), rsp, targets10)
	log("p22 w:%d", value)
	countwrites(value, 22, 25)
	l.Unlock()
	...
	l.Lock()
	value = 6
	Put(CreateTuple(45, value), rsp, targets12)
	log("p22 w:%d", value)
	countwrites(value, 22, 6)
	l.Unlock()
	...
	l.Lock()
	value = 30
	Put(CreateTuple(238, value), rsp, targets15)
	log("p22 w:%d", value)
...
func p23() {
	...
	l.Lock()
	value = 10
	Put(CreateTuple(75, value), rsp, targets12)
	log("p23 w:%d", value)
	...
	l.Lock()
	value = 5
	Put(CreateTuple(40, value), rsp, targets13)
	log("p23 w:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(39, value), rsp, targets14)
	log("p24 w:%d", value)
	countwrites(value, 24, 5)
	l.Unlock()
	...
	l.Lock()
	value = 4
	Put(CreateTuple(31, value), rsp, targets15)
	log("p24 w:%d", value)
...
func p26() {
	...
	l.Lock()
	value = 32
	Put(CreateTuple(256, value), rsp, targets14)
	log("p26 w:%d", value)
	...
	l.Lock()
	value = 15
	Put(CreateTuple(114, value), rsp, targets15)
	log("p26 w:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 6
	Put(CreateTuple(42, value), rsp, targets14)
	log("p29 w:%d", value)
	...
	l.Lock()
	value = 16
	Put(CreateTuple(127, value), rsp, targets15)
	log("p29 w:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 15
	Put(CreateTuple(116, value), rsp, targets8)
	log("p31 w:%d", value)
	countwrites(value, 31, 15)
	l.Unlock()
...
func p32() {
	...
	l.Lock()
	value = 15
	Put(CreateTuple(120, value), rsp, targets13)
	log("p32 w:%d", value)
