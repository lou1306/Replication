...
func p4() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(52, &value), rsp, s4)
	log("p4 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 18
	Put(CreateTuple(137, value), rsp, targets9)
	log("p5 w:%d", value)
...
func p6() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(203, &value), rsp, s6)
	log("p6 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(74, &value), rsp, s14)
	log("p14 r:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(184, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(67, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(160, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(130, &value), rsp, s27)
	log("p27 r:%d", value)
	countreads(value, 27, 17)
	l.Unlock()
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(172, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(100, &value), rsp, s31)
	log("p31 r:%d", value)
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(147, &value), rsp, s32)
	log("p32 r:%d", value)
