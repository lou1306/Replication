...
func p1() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(272, &value), rsp, s1)
	log("p1 r:%d", value)
...
func p2() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(392, &value), rsp, s2)
	log("p2 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(483, &value), rsp, s2)
	log("p2 r:%d", value)
...
func p3() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(48, &value), rsp, s3)
	log("p3 r:%d", value)
...
func p5() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(478, value), rsp, targets8)
	log("p5 w:%d", value)
...
func p8() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(378, &value), rsp, s8)
	log("p8 r:%d", value)
	...
	l.Lock()
	value = 12
	Put(CreateTuple(192, value), rsp, targets9)
	log("p8 w:%d", value)
	...
	l.Lock()
	value = 13
	Put(CreateTuple(202, value), rsp, targets10)
	log("p8 w:%d", value)
...
func p9() {
	...
	l.Lock()
	value = 9
	Put(CreateTuple(129, value), rsp, targets10)
	log("p9 w:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(399, &value), rsp, s9)
	log("p9 r:%d", value)
...
func p10() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(370, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(395, &value), rsp, s10)
	log("p10 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(276, &value), rsp, s10)
	log("p10 r:%d", value)
...
func p12() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(268, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(473, &value), rsp, s12)
	log("p12 r:%d", value)
	...
	l.Lock()
	value = 28
	Put(CreateTuple(441, value), rsp, targets9)
	log("p12 w:%d", value)
	countwrites(value, 12, 28)
	l.Unlock()
...
func p13() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(235, &value), rsp, s13)
	log("p13 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(39, &value), rsp, s13)
	log("p13 r:%d", value)
...
func p14() {
	...
	l.Lock()
	value = 30
	Put(CreateTuple(467, value), rsp, targets10)
	log("p14 w:%d", value)
...
func p15() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(206, &value), rsp, s15)
	log("p15 r:%d", value)
	...
	l.Lock()
	value = 31
	Put(CreateTuple(482, value), rsp, targets11)
	log("p15 w:%d", value)
	countwrites(value, 15, 31)
	l.Unlock()
}
...
func p16() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(353, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(245, &value), rsp, s16)
	log("p16 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(319, &value), rsp, s16)
	log("p16 r:%d", value)
...
func p17() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(327, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(192, &value), rsp, s17)
	log("p17 r:%d", value)
	...
	l.Lock()
	value = 14
	Put(CreateTuple(222, value), rsp, targets10)
	log("p17 w:%d", value)
...
func p18() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(312, &value), rsp, s18)
	log("p18 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(481, &value), rsp, s18)
	log("p18 r:%d", value)
...
func p19() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(202, &value), rsp, s19)
	log("p19 r:%d", value)
	...
	l.Lock()
	value = 30
	Put(CreateTuple(467, value), rsp, targets6)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 26
	Put(CreateTuple(401, value), rsp, targets7)
	log("p19 w:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(381, value), rsp, targets8)
	log("p19 w:%d", value)
...
func p20() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(357, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(58, &value), rsp, s20)
	log("p20 r:%d", value)
	...
	l.Lock()
	value = 24
	Put(CreateTuple(373, value), rsp, targets10)
	log("p20 w:%d", value)
	countwrites(value, 20, 24)
	l.Unlock()
...
func p21() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(375, value), rsp, targets6)
	log("p21 w:%d", value)
	countwrites(value, 21, 24)
	l.Unlock()
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(159, &value), rsp, s21)
	log("p21 r:%d", value)
...
func p24() {
	...
	l.Lock()
	value = 24
	Put(CreateTuple(373, value), rsp, targets9)
	log("p24 w:%d", value)
...
func p25() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(426, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(273, &value), rsp, s25)
	log("p25 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(451, &value), rsp, s25)
	log("p25 r:%d", value)
...
func p26() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(155, &value), rsp, s26)
	log("p26 r:%d", value)
...
func p27() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(265, &value), rsp, s27)
	log("p27 r:%d", value)
	...
	l.Lock()
	value = 25
	Put(CreateTuple(385, value), rsp, targets8)
	log("p27 w:%d", value)
	countwrites(value, 27, 25)
	l.Unlock()
}
...
func p28() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(209, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(473, &value), rsp, s28)
	log("p28 r:%d", value)
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(193, &value), rsp, s28)
	log("p28 r:%d", value)
...
func p29() {
	...
	l.Lock()
	value = 21
	Put(CreateTuple(321, value), rsp, targets9)
	log("p29 w:%d", value)
	countwrites(value, 29, 21)
	l.Unlock()
...
func p30() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(341, &value), rsp, s30)
	log("p30 r:%d", value)
...
func p31() {
	...
	l.Lock()
	value = 5
	Put(CreateTuple(65, value), rsp, targets10)
	log("p31 w:%d", value)
	countwrites(value, 31, 5)
	l.Unlock()
...
func p32() {
	...
	l.Lock()
	value = -1
	QueryP(CreateTuple(488, &value), rsp, s32)
	log("p32 r:%d", value)
